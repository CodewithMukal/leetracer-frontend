...
export const RecentSub = (props) => {
  ...
  return (
    <div className="border py-3 overflow-scroll my-12 flex justify-between gap-14 px-4 border-borderFromWhite bg-[#373737]/10 text-nowrap backdrop-blur-[100px] rounded-xl max-w-[100%]">
