...
export const AIRecommendation = (props) => {
  return (
    <div className="lg:w-[530px] mx-auto w-[98%] border max-h-[500px] py-6 flex flex-col gap-6 px-4 border-t-borderFromWhite border-x-borderToWhite border-b-borderToYellow/60 bg-[#373737]/10 backdrop-blur-[100px] rounded-xl">
