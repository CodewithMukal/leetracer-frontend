...
export const AIRecommendation = (props) => {
  return (
    <div className="max-w-[500px] border h-[600px] py-6 flex flex-col gap-6 px-4 border-t-borderFromWhite border-x-borderToWhite border-b-borderToYellow/60 bg-[#373737]/10 backdrop-blur-[100px] rounded-xl">
