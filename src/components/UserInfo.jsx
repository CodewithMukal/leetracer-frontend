  ...
  return (
    <div className="border py-3 flex flex-col gap-14 px-4 border-borderFromWhite bg-[#373737]/10    backdrop-blur-[100px] rounded-xl w-[688px] max-w-[90%]">
      <div className="flex justify-between items-center">
        ...
        <a href={props.link} target="_blank" className="flex font-bold lg:text-xl gap-1 justify-center items-center">
      ...
      <div className="flex justify-around">
        <div className="flex flex-col w-fit gap-2 font-[Geist] justify-center items-center">
          {props.total && props.totalComp ? (
            <div className="lg:w-32 w-22 h-22 font-bold lg:h-40 flex flex-col justify-center items-center gap-2">
              <CircularProgressbar
                ...
                strokeWidth={10}
              />
              <p className="font-bold text-[8px] lg:text-sm">
        ...
        <div className="flex flex-col gap-2 justify-center items-center">
          {(props.easyComp || props.easyComp===0) && props.easy ? (
            <div className="lg:w-32 w-22 h-22 flex flex-col gap-2 justify-center items-center font-bold lg:h-40">
              <CircularProgressbar
        ...
        <div className="flex flex-col gap-2 justify-center items-center">
          {(props.medComp || props.medComp===0) && props.med ? (
            <div className="lg:w-32 w-22 h-22 font-bold lg:h-40 flex flex-col gap-2 justify-center items-center">
              <CircularProgressbar
                ...
                strokeWidth={10}
              />
              <p className="font-bold text-nowrap text-[8px] lg:text-sm">
        ...
        <div className="flex flex-col gap-2 justify-center items-center">
          {(props.hardComp|| props.hardComp===0) && (props.hard) ? (
            <div className="lg:w-32 w-22 h-22 font-bold lg:h-40 flex-col flex justify-center items-center gap-2">
              <CircularProgressbar
      ...
      <div className="flex justify-center gap-[30%] items-center">
        {
          ...
          (
            <div className="lg:w-32 md:w-20 md:h-20 w-16 h-16 flex flex-col justify-center items-center lg:h-40">
          <PieChart
            data={[
              {
                title: "Easy Solved",
  ...
  return (
    <div className="border mx-auto py-3 flex flex-col gap-14 px-4 border-borderFromWhite bg-[#373737]/10    backdrop-blur-[100px] rounded-xl w-[688px] max-w-[100%]">
      ...
      <div className="flex justify-around">
        ...
        <div className="flex flex-col gap-2 justify-center items-center">
          {(props.easyComp || props.easyComp===0) && props.easy ? (
            <div className="w-full flex flex-col gap-2 justify-center items-center font-bold h-40">
              <CircularProgressbar
                value={(props.easyComp / props.easy) * 100}
                text={`${((props.easyComp / props.easy) * 100).toFixed(2)}%`}
                styles={buildStyles({
      ...
      <div className="flex justify-between items-center">
        <div className="font-bold text-[14px] font-[Inter] text-white">
          <p>Acceptance Rate: {props.acceptanceRate ? props.acceptanceRate + "%" : "Loading..."}</p>
          <p>Global Ranking: {props.rank ?"#"+ (props.rank).toLocaleString() : "Loading..."}</p>
        </div>
        <div className="font-bold font-[Inter] text-white">
